...
# A la población le encanto el humilde local y su servicio cercano y familiar, con el paso del tiempo ganó gran popularidad y logró participar y ganar un concurso a la mejor tableta de chocolate del mundo. 

# Esto llamó la atención de un inversor fanático del mundo del chocolate y decidió ir al local a  probar la tableta y gran variedad de productos a la venta. Le gustó tanto que no dudó en ponerse en contacto con la familia Ecuatoriana, para proponerles la idea de montar una fábrica de chocolate, con el objetivo de llegar a un público más internacional. 

# A la Familia no le convencía la idea, porque aunque uno de sus sueños era poder vender sus productos de manera internacional, no querían renunciar a su autenticidad, naturalidad y artesanía, querían mantener su esencia y su producto natural, no querían montar una fábrica que hiciera un producto artificial.

# El inversor, al ver las dudas de la familia, les prometió que montaría una fábrica especial para poder mantener esa esencia y que fuera el mismo chocolate natural, siguiendo las mismas recetas y consiguiendo el mismo sabor. 

# Le daba igual tener que contratar más empleados, adquirir unas máquinas más experimentales para la fábrica, contratar una empresa que pudiera trasladar grandes cargamentos de cacao importado del Amazonas,etc.
...
# Patrocinios y colaboraciones con marcas afines.
